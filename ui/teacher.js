            ...
            <div class="d-flex flex-row bd-highlight mb-3">
                <div class="p-2 w-50 bd-highlight">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" v-model="Preferencies">
                    </div>

                </div>
            </div>
                <button type="button" @click="createClick()"
                v-if="TeacherId==0" class="btn btn-primary">
                Create
                </button>
...
methods:{
    ...
    editClick(tch){
        ...
        this.TeacherId=tch.TeacherId;
        this.TeacherName=tch.TeacherName;
        this.Department=tch.Department;
        this.Preferencies=tch.Preferencies;
    },
    createClick(){
