...
from TimetableApp.models import Auditory, Constraints, Department, EducationalPrograms, Faculties, GeneratedEntities, Groups, Subjects, Teacher, Group, Classroom, Teachers, entries
